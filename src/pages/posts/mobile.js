export const mobile = (
    <>
        <p className='date'>April 15th, 2022</p>
        ...
        <div className='text'>
            ...
            <p>I might sketch out a quick wireframe in my notebook<sup>1</sup> before starting to code, especially if the design is a little more complicated or I’m not exactly sure how I want it to look.</p>
            ...
            <hr />
            <p><span className='footnote'>1</span> I use a Rocketbook; feel like this makes it easy to erase my quick sketches or notes when I no longer need them.</p>
            <p><span className='footnote'>2</span> Pew Research Center: Mobile Fact Sheet</p>
        </div>
    </>
)